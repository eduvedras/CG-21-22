...
function createRocket(){
    ...
    group2.add(group1);
    group2.position.set(
            (R+body_length/2)*Math.sin(fi)*Math.cos(teta),
            (R+body_length/2)*Math.cos(fi),
            (R+body_length/2)*Math.sin(fi)*Math.sin(teta));
